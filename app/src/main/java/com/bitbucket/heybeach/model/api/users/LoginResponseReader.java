...
/**
 * Parser that reads the {@link UserJson response} coming back for a login request.
 * The parser is strict.
 */
class LoginResponseReader {
  ...
  UserJson read(InputStream inputStream) throws JsonReaderException {
    ...
    try (JsonReader reader = new JsonReader(new InputStreamReader(inputStream))) {
      ...
      throw new JsonReaderException("Failed to read user from login response.", e);
    }
  }
